    ...
    $this->write(3, "I, the undersigned, do hereby state that I am a registered voter of the political unit for " .
		...
		*/
		...
		if ($this->PetitionType == "independent") {
			...
			$this->Image($_SERVER["DOCUMENT_ROOT"] . "/../../" . $StaticPathForImgs . "/htdocs/shared/logos/" . $this->EmblemImagePath, 
																					196, 8, 015);			
			...
			if ( ! empty ($this->EmblemFontType)) {
				...
				$this->Image($_SERVER["DOCUMENT_ROOT"] . "/../../" . $StaticPathForImgs . "/htdocs/shared/logos/" . $this->EmblemImagePath, $this->GetX() + 1, $this->GetY() - 0.6, 02.5);
				$this->Write(3, "   ");
			}
