				...
				<div class="Box">
					...
					<div id="voters">
						...
						<div class="list-group-item filtered">
								...
								<?= $rmbvoters["Raw_Voter_ID"] ?> - <?= $rmbvoters["Raw_Voter_UniqNYSVoterID"] ?><BR>
								...
								<B>Status:</B> <?= $rmbvoters["Raw_Voter_Status"] ?> - <B>Last Time Voted:</B> <?= $rmbvoters["Raw_Voter_LastDateVoted"] ?>
						</div>
