...
?>
                      <INPUT TYPE="checkbox" name="TeamMembership[<?= $teaminfo["Team_ID"]  ?>]" value="<?= $teaminfo["Team_ID"] ?>"<?= $CheckBoxOptions ?>>&nbsp;<?= $teaminfo["Team_Name"] ?><?php
            if (! empty ($teammember[$TeamMembership[$teaminfo["Team_ID"]]]) || ! empty ($CheckBoxOptions)) { ?> - Active: <INPUT TYPE="checkbox" name="TeamMembershipActive[<?= $teaminfo["Team_ID"]  ?>]" value="<?= $teaminfo["Team_ID"] ?>"<?php if ($teammember[$TeamMembership[$teaminfo["Team_ID"]]]["TeamMember_Active"] == "yes") { echo " CHECKED"; } ?>><?php } ?><BR>
<?php      
                }
              }
            }          
