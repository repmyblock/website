<?php
	...
	$HeaderTwitter = "yes";
	$HeaderTwitterTitle = "Rep My Block - Queens County Committee for All";
	$HeaderTwitterPicLink = "https://static.repmyblock.org/pics/paste/QCC4ALL.jpg";
	...
	$imgtoshow = "/brand/qcc4all/qcc4all.png";
?>
