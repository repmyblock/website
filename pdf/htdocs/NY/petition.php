...
$WritenSignatureMonth = "May / June"; // date("F");
$Variable = "demo-CC";
...
#Version_One($TotalCountName, $pdf, $DateForCounter);
Version_Two($TotalCountName, $pdf, $DateForCounter);

$pdf->Output("I", $Petition_FileName);

function Version_One ($TotalCountName, $pdf, $DateForCounter) {
...
function Version_Two ($TotalCountName, $pdf, $DateForCounter) {
