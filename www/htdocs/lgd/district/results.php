...
?>
    ...
    <div class="row layout">
      ...
      <div class="main">
        <div class="col-full">
          <div class="Subhead">
            <h2 class="Subhead-heading">Election Results</h2>
          </div>
                    ...
                    <div class="table-list-header-toggle states">Results for 
                      ...
                      <TABLE WIDTH=100%>
                        <TR ALIGN=CENTER>
                          ...
                          <TH style="padding:0px 10px;">ED</TH><TD><INPUT TYPE="INPUT" NAME="ED" VALUE="<?= $SearchED ?>" SIZE=2></TD>
...
?>
                  <TR ALIGN=CENTER VALIGN=TOP>                    
                    <TD style="padding:0px 10px;<?= $style ?>"><?= PrintDate($var["Elections_Date"]) ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["Elections_Type"] ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["CandidateElection_Text"] ?></TD>
                      <?php if ($var["CandidateElection_Number"] > 1) { echo "<I>(Vote for " . $var["CandidateElection_Number"]. ")</I>"; } ?>
                    </td>
                    <TD style="padding:0px 10px;<?= $style ?>">&nbsp;</TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["ElectResultAdmin_PubCounter"] ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["ElectResultAdmin_ManualEmerg"] ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["ElectResultAdmin_AbsMili"] ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["ElectResultAdmin_Affidavit"] ?></TD>
                    <TD style="padding:0px 10px;<?= $style ?>"><?= $var["ElectResultAdmin_Scattered"] ?></TD>
                  </TR>
<?php
                  ...
                  <TR>                    
                    ...
                    <TD style="padding:0px 10px;text-align:right"><?= $var["ElectResultCandidate_Count"] ?></TD>
