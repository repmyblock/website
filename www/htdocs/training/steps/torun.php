<?php 
  ...
  $HTMLTitle = "How to run for office | Rep My Block, your stating point to running for office";
  $HTMLDesc = "Whatch these simple steps to understand how easy it is by following these simple steps.";  
    
  $HeaderTwitter = 1;
  $HeaderTwitterPicLink = "https://static.repmyblock.org/pics/paste/DeadMembers.jpg";
  $HeaderTwitterDesc = $HTMLDesc;
