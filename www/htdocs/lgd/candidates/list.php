<?php
  ...
  $result = $rmb->ListElectionPositionsForEDAD($rmbperson["SystemUser_EDAD"], $rmbperson["SystemUser_StateAbbrev"]);  
...
?>  
        <P class="f40">
          <B>This is the current list of candidates that are running in <?= $rmbperson["SystemUser_EDAD"] ?></B>
        </P>
        ...
        <DIV class='container2'>
          ...
          <DIV class='container3'>
            ...
            <DIV class="f60">
              ...
              <DIV style="padding: 15px; " CLASS="f60">
            <IMG SRC="<?= $PicturePath ?>" class='iconDetails'>
          </DIV>  
