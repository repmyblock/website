...
class PDF_Multi extends PDF_Code128 {
  ...
  var $Line_Left = 6; var $Line_Right = 209; var $Line_Col1 = 61; var $Line_Col2 = 150;
    ...
    $this->Write(3, "To the Board of Elections: " );
    ...
    if ($this->PetitionType == "independent") {
		...
		$YLocation_new = $Top_Corner_Y = $this->GetY() + 3.7;   
	...
	function Footer()	{
   	...
   	$YLocation = $this->GetY() - 1.9;
		...
		if ( empty ($this->WitnessResidence)) {
			...
			$this->WitnessResidence = "________________________________________________________, New York"; 
		}
		...
		$PartyLength = $this->GetStringWidth($this->party);
