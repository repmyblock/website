...
?>
    ...
    <div class="row layout">
      ...
      <div class="main">
        <div class="col-full">
          <div class="Subhead">
            <h2 class="Subhead-heading">Information not found</h2>
          </div>
          We did not find the Voter ID information. We Return nothing.
        </DIV>
      </DIV>
    </DIV> 
<?php
        ...
        <div class="Box">
          <div class="Box-header pl-0">
            <div class="table-list-filters d-flex">
              <div class="table-list-header-toggle states flex-justify-start pl-3 p40">Voter Card</div>
            </div>
          </div>
          ...
          <P>
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">First</div>
                      <div class="p40 table-header-cell">Middle</div>
                      <div class="p40 table-header-cell">Last</div>
                      <div class="p40 table-header-cell">Suffix</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $var["DataFirstName_Text"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataMiddleName_Text"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataLastName_Text"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["VotersIndexes_Suffix"] ?></div>
                      </div>                          
                    </div>
                  </div>
                </P>  
                ...
                <P>
                  ...
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Assembly</div>
                      <div class="p40 table-header-cell">ED</div>
                      <div class="p40 table-header-cell">Congress</div>
                      <div class="p40 table-header-cell">County</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_StateAssembly"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Electoral"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Congress"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataCounty_Name"] ?></div>
                      </div>                          
                    </div>
                  </div>
                </P>  
                ...
                <P>
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Address</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $AddressLine1 ?><BR><?= $AddressLine2 ?></div>
                      </div>                          
                    </div>
                  </div>
                </P>  
                ...
                <P>
                  ...
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Legis</div>
                      <div class="p40 table-header-cell">Town</div>
                      <div class="p40 table-header-cell">Ward</div>
                      <div class="p40 table-header-cell">Senate</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Legislative"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrictTown_Name"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Ward"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_StateSenate"] ?></div>
                      </div>                          
                    </div>
                  </div>
                ...
                <P>
                  ...
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Date of Birth</div>
                      <div class="p40 table-header-cell">Age</div>
                      <div class="p40 table-header-cell">Gender</div>
                      <div class="p40 table-header-cell">Party</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= PrintShortDate($var["VotersIndexes_DOB"]);  ?></div>
                        <div class="p40 table-body-cell"><?= $difference->y; ?></div>
                        <div class="p40 table-body-cell"><?= $var["Voters_Gender"] ?></div>
                        <div class="p40 table-body-cell"><?= PrintParty($var["Voters_RegParty"]) ?></div>
                      </div>                          
                    </div>
                  </div>
                </P>  
                ...
                <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Council</div>
                      <div class="p40 table-header-cell">Civil Court</div>
                      <div class="p40 table-header-cell">Judicial</div>
                    
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Council"] ?>&nbsp;</div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_CivilCourt"] ?></div>
                        <div class="p40 table-body-cell"><?= $var["DataDistrict_Judicial"] ?></div>
                ...
                <P>
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Board of Election ID #</div>
                    </div>

                    <div id="resp-table-body">
                      <div class="resp-table-row">
                        <div class="p40 table-body-cell"><?= $var["Voters_CountyVoterNumber"] ?></div>
                      </div>                          
                    </div>
                  </div>
                  ...
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Select Petitions to Create</div>
                      <div class="p40 table-header-cell">district</div>
                    </div>
                ...
                <P>
                  <div id="resp-table">
                    <div id="resp-table-header">
                      <div class="p40 table-header-cell">Email Information</div>
                    ...
                    <div id="resp-table-body">
                      <div class="resp-table-row">
                            ...
                            <div class="p40 table-body-cell-left"><INPUT TYPE="TEXT" SIZE="40" NAME="ContactInfo" VALUE="<?= $EmailInformation ?>"></DIV>
                      </div>                          
                    </div>
                  </div>
