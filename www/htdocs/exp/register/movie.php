...
<DIV class="main">
	...
	<P>
		<P CLASS="f80">The password is <FONT COLOR=BROWN><B>QCC4ALL!</B></FONT> <I>(all in uppercase)</I></P>
	...
	<P>		
		<CENTER>
			<DIV class="videowrapper">
				...
				<div class="wistia_embed wistia_async_qmt1psxdt4 videoFoam=true" style="height:100%;position:relative;width:100%"><div class="wistia_swatch" style="height:100%;left:0;opacity:0;overflow:hidden;position:absolute;top:0;transition:opacity 200ms;width:100%;"><img src="https://fast.wistia.com/embed/medias/qmt1psxdt4/swatch" style="filter:blur(5px);height:100%;object-fit:contain;width:100%;" alt="" aria-hidden="true" onload="this.parentNode.style.opacity=1;" /></div></div></div></div>
			</DIV>		
		</CENTER>
	</P>
</CENTER>
