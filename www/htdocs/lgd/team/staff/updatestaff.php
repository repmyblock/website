              ...
              <div class="Box">
                <div class="Box-header pl-0">
                  <div class="table-list-filters d-flex">
                    <div class="table-list-header-toggle states flex-justify-start pl-3 f60">Update staff member for <B><?= $ActiveTeam ?></B></div>
                  </div>
                </div>
...
<?php  foreach ($resultteam as $var) { 
        if ( ! empty ($var)) { ?>
                      ...
                      <TR>
                        ...
                        <TD><A HREF="/<?= $var["SystemUserTeamPending_ID"] ?>/updatestaff">Update</A></TD>                     
                      </TR>
<?php              }  
                 } ?>
                    </TABLE>
