...
<div class="main">
	...
	<P>
		...
		<DIV>
			...
			<A class="action-nominate" HREF="https://repmyblock.org/<?= $middleuri ?>/exp/propose/nomination" CLASS="NomCandidate"><img class="action-nominate" src="/images/options/Nominate.png" alt="NOMINATE A CANDIDATE"></A>
		</DIV>
	...
	<P>
		<P CLASS="f80 center"><A HREF="/<?= $middleuri ?>/exp/training">Access the video chats</A></P>
	</P>
