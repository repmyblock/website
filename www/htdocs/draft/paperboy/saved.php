<?php
	...
	$HeaderTwitterDesc = "I filed to run for President of the United States ! ";   
...
<DIV class="right f80 p05">Help put Paperboy Love Prince on the ballot!</DIV>
		...
		<h1>Draft Paperboy Love Prince for President of the United States</h1>
			...
			<P class="f60">
				Once you loggin for the first time, a Draft Paperboy team volunteer will contact you. It can be from 1 day to 2 month depending on the amount of
				people responding.
			</P>
			...
			<P CLASS="f60">
				Don't forget to send the code to <A TARGET="SendEmailSurvey" HREF="mailto:paperboy@team.repmyblock.org?subject=Save Survey Code <?= $Match[1][0] ?>&body=DO NOT CHANGE THE SUBJECT.\nJust send the email as is for the computer to reply with the link.\nSurveyCode: <?= $Match[1][0] ?>"><B>paperboy@team.repmyblock.org</B></A>. 
			</P>

			<P CLASS="f60">
				<B>The Draft Paperboy 2024 volunteer team.</B>
			</P>
