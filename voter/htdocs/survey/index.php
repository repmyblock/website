<?php 
	header("Location: https://www.repmyblock.org/rmoveon/draft/aoc");
	exit();
...
?>
  <section>
    ...
    <p>This is a non-partisan survey in colaboration with <A TARGET="RMB" HREF="https://repmyblock.org">Rep&nbsp;My&nbsp;Block</A>. <I>(all answers are optional)</I></p>
