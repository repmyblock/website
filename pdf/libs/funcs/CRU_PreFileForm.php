...
class PDF_Multi extends PDF_Code128 {
  ...
  var $Line_Left = 6; var $Line_Right = 209; var $Line_Col1 = 61; var $Line_Col2 = 150;
    ...
    $this->SetXY(15, 40); 
    $this->Cell( 11, 4, "EVENT",0 ,0, 'L');		
    $this->SetXY(30, 40);
    $this->SetFont('Arial','B',18);
    $this->Cell( 50, 15, $this->Election, 1 ,0, 'C');		
    
    $this->SetXY(109, 38); 
		$this->SetFont('Arial','',8);
		$this->Cell(50,2.5, "Name of Party or Independent Body", 0, 0,'L');		
	 	$this->SetXY(110, 40.5); 
		$this->SetFont('Arial','B',18);
    $this->Cell( 80, 10, $this->PartyName, 1 ,0, 'L');		
    
    // Petition Type
    $this->SetXY(80, 60); 
		$this->SetFont('Arial','',8);
    $this->Cell(50, 4, "Petition Type:", 1, 1, 'L');		
    ...
    $this->Cell(34, 4, "Opportunity to Ballot", 1, 0, 'L');		
   	...
   	$this->SetXY(10, 90); 
		$this->SetFont('Arial','',8);
    $this->MultiCell(12, 4, "Date of Event:", 0, 'C');		

		$this->SetXY(27, 89);
		$this->SetFont('Arial','B',18);
		$this->Cell(34, 10, $DatePrintEvent, 0, 0, 'C');		
    ...
    $this->SetFont('Arial','',8);
   	$this->SetXY(80, 100); 
    $this->Cell(120, 4, "Applicant", 1, 0,'C');		
   	...
   	$this->SetXY(80, 116); $this->Cell(120, 4, "Address:", 0, 0,'L');		
		...
		$this->SetFont('Arial','B',8);
		$this->SetXY(84, 163.5); 
    $this->MultiCell(60, 3, "Check here if petition is filed without a Petition ID Sticker", 0, 'C');		
