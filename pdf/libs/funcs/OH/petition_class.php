  ...
  var $Line_Left = 6; var $Line_Right = 209; var $Line_Col1 = 61; var $Line_Col2 = 150;
	...
	function Header()	{
		...
		if (! empty ($this->DemoPrint)) {		
			...
			$this->Link(125, 1, 90, 10, "https://repmyblock.org/exp/multipetition/propose");
    ...
    $this->Cell(0,0, "Declaration of Candidacy", 0, 0, 'C');
    $this->Ln(4);
    $this->Cell(0,0, $this->party . " Party Primary Election",0,0,'C');
    $this->Ln(4);
		$this->Cell(0,0, "For members of the " . $this->party . " " . $this->county . ' County Central Committee',0,0,'C');
    $this->Ln(3);    
    
   	$this->SetFont('Arial','',8);
		  
		$this->MultiCell(0,2.8, "I, " . $CandidateName . "the undersigned, hereby declare under penalty of election " . 
														"falsification that Name of Candidate my voting residence address is " .
														$this->Address . ", " . $this->Village . ", Ohio " . $this->Zipcode . ", " .
														"and I am a qualified elector residing in the political subdivision I wish to represent.");
		
			$this->Ln(2.8);												
		$this->MultiCell(0,2.8, "I further declare that I desire to be a candidate for election to the office of Member of the " .
														$this->County . " County Central Committee as a member of the " . $this->Party . " Party from: " .
														$this->LineLocation . "at the primary election to be held on the " . $this->writendate . ".");
  	$this->Ln(2.8);
		...
		$this->MultiCell(205,2.8, "I further declare that, if elected to this office, I will qualify therefor, and that I will support " . 
															"and abide by the principles enunciated by the " . $this->Party . " Party.");
  

		$this->Ln(2.8);
		$this->MultiCell(205,2.8, "Day Month Dated this .");
			$this->Ln(2.8);
	$this->Cell(0,0, "WHOEVER COMMITS ELECTION FALSIFICATION IS GUILTY OF A FELONY OF THE FIFTH DEGREE");
    	$this->Ln(2.8);
    ...
    for ($i = 0; $i < $this->NumberOfCandidates; $i++) {
   	...
   	$this->SetFont('Arial','B',8);
    	$this->MultiCell(205,2.8, "We, the undersigned, qualified electors of the State of Ohio, whose voting residence is in the county, city, " . 
		"village, or township, set opposite our names, and members of the " . $this->party . " Party , hereby certify Name of Candidate, " .
		"whose declaration of candidacy is filed herewith, is in our opinion, well qualified to perform the duties of the office or " . 
	...
	function Footer()	{
   	...
   	$YLocation = $this->GetY() - 1.9;
		...
		$this->Cell(0,0, "Circulator Statement", 0, 1, 'C');		
		$this->SetFont('Arial','',10);
		$this->Ln(1);
		$this->MultiCell(0, 4.2, 
			"I, " . $this->WitnessName . " declare under penalty of election falsification that I reside at the address " . 
			"appearing below my signature; that I am a member of the " . $this->party . " Party; that I am the circulator " .
			"of the foregoing petition containing ____ signatures; that I witnessed the affixing of every signature; " .
			...
			"acting pursuant to section 3501.382 of the Revised Code..", 0, 'L', 0);
// " . $this->WitnessResidence . ". Each " . 
		...
		*/
		...
		if (! empty ($this->DemoPrint)) {		
			...
			$this->SetXY(40, 50);
			$this->Link(40, 50, 80, 30, "https://repmyblock.org/exp/multipetition/propose");
 	   	$this->MultiCell(80, 8, "We'll provide you the list of " . $this->party . 
				 	   									" voters to ask for signatures.", 0, 'C');

			$this->SetTextColor(0,0,255);
			$this->SetXY(120, 132.5);
			$this->Link(120, 130, 70, 25, "https://repmyblock.org/exp/multipetition/propose");
