...
<div class="main">
	...
	<P><H2><A HREF="/register">Register on the Rep My Block website</A></H2></P>
	...
	<div class="panel2">
		...
		<P CLASS="f60 center"><A HREF="/register">Register on the Rep My Block website</A></P>
	
	</DIV>


	<button class="accordion2">The Second Step</button>
	<div class="panel2">
	...
	<button class="accordion2">The Third Step</button>
	<div class="panel2">
	...
	<P CLASS="f60"><A HREF="/register">Register on the Rep My Block website</A></H2></CENTER></P>
	</DIV>


	<button class="accordion2">The Fourth Step</button>
	<div class="panel2">
	...
	<P CLASS="f60"><A HREF="/register">Register on the Rep My Block website</A></P>

	
		</DIV>


	<button class="accordion2">The Fifth Step</button>
	<div class="panel2">
	...
	<button class="accordion2">The Sixth Step</button>
	<div class="panel2">
	...
	<button class="accordion2">The Seven Step</button>
	<div class="panel2">
