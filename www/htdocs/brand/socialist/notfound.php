...
<DIV class="main">
	...
	<?php if (! empty ($URIEncryptedString["Error"])) {
		echo "<P class=\"f60 p20\"><FONT COLOR=BROWN><B>" . $URIEncryptedString["Error"] . "</B></FONT></BR>";
		echo "Please enter your contact information and someone will contact you shortly.";
		echo "</P>";
	} else { ?>
	
	
	<P class="f60 p20">
		Please enter your contact information and 
	...
	<FORM METHOD="POST" ACTION="">			
		...
		<P class="f80">
			...
			<DIV><INPUT class="" type="text" autocorrect="off" autocapitalize="none" NAME="Email" PLACEHOLDER="Email Address" VALUE="<?= $URIEncryptedString["email"] ?>"></DIV>
		</P>
