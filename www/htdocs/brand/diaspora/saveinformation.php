...
<DIV class="main">
	...
	<DIV class="right f80"><?= $BrandingTitle ?></DIV>
		...
		<P class="f60 p20">
			<B>Thanks for filling out the registration form.</B> 
		</P>
		
		<P class="f60">
			A candidate for New York City Council from the 
			Republican or Democratic party will contact you shortly 
			to help navigate the the system.
		</P>
