...
<head>
    ...
    <script>
        function auth_popup( provider ){
            ...
            var authWindow = window.open('https://dev-repmyblock.repmyblock.nyc/register/examples/example_07/callback.php?provider='+provider, 'authWindow', 'width=600,height=400,scrollbars=yes');
            return false;
        }
    </script>
