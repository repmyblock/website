<?php
	...
	$nys = $_GET["nys"];
	$r = new OutragedDems();
	$RawVoter = $r->FindRawVoterbyNYSVoterID($DatedFiles, $nys);
	$RawVoter = $RawVoter[0];
	$Result = $r->FindRawVoterbyADED($DatedFiles, $RawVoter["Raw_Voter_ElectDistr"], $RawVoter["Raw_Voter_AssemblyDistr"], 1);
  ...
  $pdf->LeftText = $pdf->Text_Party . " Manual Request: " . $RawVoter["Raw_Voter_ID"];
	$pdf->RightText =  $RawDatedFiles . " - " . $pdf->Text_DistricType . ":" . $pdf->Text_DistricHeading;
